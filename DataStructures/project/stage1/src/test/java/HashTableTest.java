...
public class HashTableTest {
    ...
    @Test
    protected void getReturnWorksInteger() {
    ...
    // calculate first)
    @Test
    protected void getReturnWorksWithDuplicates() {
    ...
    @Test
    protected void getReturnWorksNull() {
        HashTable<Integer, Double> table = new HashTableImpl<>();
        table.put(3, 3.14156);
        table.put(3, null);
    ...
    @Test
    protected void getReturnWorksNullWithDuplicates() {
        HashTable<Integer, String> table = new HashTableImpl<>();
        table.put(4, "The best number");
    ...
    @Test
    protected void putReturnWorksNull() {
        HashTable<Integer, String> table = new HashTableImpl<>();
    ...
    @Test
    protected void putReturnWorksNullWithDuplicates() {
        HashTable<Integer, String> table = new HashTableImpl<>();
        table.put(4, "The best number");
        assertNull(table.put(-4, "An even better number"));
    }
